<?php
/*
    require includes the contents of a file. if the
    file does not exist, an error is raised and 
    execution ends.
    
    include does the same thing as require, but if the
    file does not exist, include raises a warning and 
    execution continues.
*/
...
//strpos: returns the starting character position of the first match in
//a string or FALSE if no match is found.

$word = "wonderful";

//$pos will be false if the word is not found, but a number
